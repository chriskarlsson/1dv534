...
const String String::operator+ (const String& string) const
{
    ...
    auto tempCString = new char[stringLength + _strLen + 1]{ 0 };
...
const String String::operator+ (const char* cString) const
{
    ...
    auto tempCString = new char[cStringLength + _strLen + 1]{ 0 };
    strcpy(tempCString, _strPtr);
...
{
    auto cStringLength = strlen(cString);
    auto tempCString = new char[cStringLength + string._strLen + 1]{ 0 };
