...
#include <Clock.h> // give_me_the_time
#include <MyTime.h> // MyTime
...
int Typing::run()
{
    ...
    do
    {
        char userInput[_MAX_READ_INPUT_LENGTH];
...
{
    char input[_MAX_READ_INPUT_LENGTH];
...
{
    cin.getline(userInput, _MAX_READ_INPUT_LENGTH);
    ...
    if (cin.fail())
    {
        ...
        cin.ignore(_MAX_READ_INPUT_LENGTH, '\n');
    }
}
